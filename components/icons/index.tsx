/**
 * Standardized SVG Icon Library for Blueprint
 * 
 * All icons follow consistent patterns:
 * - Size: w-5 h-5 (20x20) for standard, w-4 h-4 (16x16) for small, w-6 h-6 (24x24) for large
 * - viewBox: "0 0 24 24"
 * - fill: "none"
 * - stroke: "currentColor"
 * - strokeWidth: "2"
 ...
 * - className: inherits text color from parent
 */
...
const IconWrapper = ({ size = 'md', className = '', children, ...props }: IconProps & { children: React.ReactNode }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const ContentIcon = (props: IconProps) => (
  <IconWrapper {...props}>
